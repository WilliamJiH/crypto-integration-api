...
const createLimiter = rateLimit({
  ...
  message:
    "Too many requests to this endpoint. Please wait a moment and try again.",
...
router.get("/getTransaction", ethController.getTransaction);
router.get("/getTransactionReceipt", ethController.getTransactionReceipt);
